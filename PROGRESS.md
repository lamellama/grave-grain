...
**VS-3 status:** T1 groups ✅ + T2 shelter ✅ + T3 coop-build wiring ✅. **NEXT: VS-3 T4 (split→own shelter + merge→abandon-redundant)** — or knock out playtest P/Q/O/N first if prioritized.
