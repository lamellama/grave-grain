...
**VS-3 status:** T1 groups ✅ + T2 shelter ✅ + T3 coop-build wiring ✅ + geometry pass ✅ (hut physically buildable end-to-end). **NEXT: VS-3 T4 (split→own shelter + merge→abandon-redundant).**
