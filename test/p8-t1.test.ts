...
// stays id 14. Round 11 added SPIKE (id 19) -> length 20; oak trees added
// TRUNK (id 20) -> length 21.
assert(MATERIALS.length === 21, 'MATERIALS.length === 21 (Phase 8 + SNOW + CAMPFIRE + DOOR + SPIKE + oak TRUNK)');
